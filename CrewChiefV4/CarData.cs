...
namespace CrewChiefV4
{
    public class CarData
    {
        ...
        public enum CarClassEnum
        {
            ...
            COPA_CLASSIC_A, COPA_CLASSIC_B, COPA_FUSCA, COPA_HOT_CARS, TRUCK, COPA_UNO, REIZA_FV12, LANCER_CUP, MINI_CHALLENGE, COPA_MONTANA, OPALA_STOCK_OLD, OPALA_STOCK_79, OPALA_STOCK_86, SPRINT_RACE, F_VEE
        }
