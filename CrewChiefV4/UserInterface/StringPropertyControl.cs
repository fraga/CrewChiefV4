...
namespace CrewChiefV4
{
    public partial class StringPropertyControl : UserControl
    {
        ...
        public StringPropertyControl(String propertyId, String label, String currentValue, String defaultValue, String helpText, String filterText, String categoryText, String metadataText)
        {
            InitializeComponent();
