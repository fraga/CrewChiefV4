...
namespace CrewChiefV4
{
    public partial class IntPropertyControl : UserControl
    {
        ...
        public IntPropertyControl(String propertyId, String label, int value, int defaultValue, String helpText, String filterText, String categoryText, String metadataText)
        {
            InitializeComponent();
