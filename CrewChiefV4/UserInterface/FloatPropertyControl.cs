...
namespace CrewChiefV4
{
    public partial class FloatPropertyControl : UserControl
    {
        ...
        public FloatPropertyControl (String propertyId, String label, float value, float defaultValue, String helpText, String filterText, String categoryText, String metadataText)
        {
            InitializeComponent();
