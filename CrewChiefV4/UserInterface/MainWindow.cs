            ...
            if (_IsAppRunning)
            {
                if (CrewChief.gameDefinition.gameEnum == GameEnum.ACC)
                {
                    MessageBox.Show("The data exposed by ACC has numerous data synchronization issues and inaccuracies (bugs). These, along with the requirement to combine shared memory " +
                        ...
                        "We aren't planning any further work to improve ACC support and it's likely that ACC support will be removed entirely in a future version. \n\n" +
                        "We recommend using ACC's built in crew chief / spotter", "ACC Support deprecated");
                }
