...
namespace CrewChiefV4.Events
{
    class LapCounter : AbstractEvent
    {
        ...
        override protected void triggerInternal(GameStateData previousGameState, GameStateData currentGameState)
        {
            ...
            if ((!currentGameState.SessionData.SessionHasFixedTime || CrewChief.gameDefinition.gameEnum == GameEnum.RF2_64BIT) &&  // VL: rF2 implements IsLastLap in timed race, and so does iRacing, but I'll let Morten decide if he wants this.
                currentGameState.SessionData.SessionType == SessionType.Race &&
