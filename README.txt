...
Changelog
---------
Version 4.15.0.0: Added full support for GTR2, see [tbd] for installation and setup instructions; R3E - added rating-based finishing position expectation messages and voice command ("what's my expected finish position?"); RBR / Dirt / Dirt2 - rally stage notes creation improvements - added "into", "and" and "then" items, added "tightens to [1/2/3/4/5/hairpin]" command, ensure pace notes are ordered correctly, some other fixes and improvements; various bug fixes
