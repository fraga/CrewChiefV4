...
Changelog
---------
Version 4.17.1.0: Rework opponent name matching to be more accurate and more conservative; added UI to modify suppress or manually override guessed opponent name matches ("Opponent Names" from the app's menu bar) - restart the app after making changes to guessed opponent name matches
