...
See this thread for more information: https://thecrewchief.org/showthread.php?1011-rFactor-2-Unofficial-Features
...
-debug - collects CC debug trace.  For more info see here: https://thecrewchief.org/showthread.php?142-How-to-collect-Crew-Chief-repro-traces
...
Changelog
---------
Version 4.16.0.4: ACC - various improvements to data synchronization and stability work arounds. This should improve the ACC experience significantly; AMS2 & R3E - open shared memory with read-access only. This should address some startup issues when using the app with other tools that access the games' shared memory files; GTR2 - plugin update; A few minor bug fixes
