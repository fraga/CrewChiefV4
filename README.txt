...
Changelog
---------
Version 4.14.0.6: Fixed 'force single class' option (was being ignored by the app); Fix timing issue in multiclass races for some games; Some rally mode improvements - added 'Minimum rally distance pace note distance (metres)' property to set how far ahead the next pace note needs to be before the app inserts a distance call, added a few more corner / obstacle types to the rally speech recogniser ('open hairpin left / right', 'go-straight', 'danger / triple caution' and 'trees / logs / rocks inside / outside'), added more corner modifiers ('opens', 'very long' and 'plus / minus'); R3E - added "What's the strength of field?" and "What are my incident points?" voice commands; iRacing - fixed missing meatball flag message; AMS2 - updated car mappings for new classes; RF2 - added more tyre types to the pit menu
