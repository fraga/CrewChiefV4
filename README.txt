...
Changelog
---------
Version 4.13.1.4: Added some interpolation for car timing positions - should address issues with wildly inaccurate gap messages where stale data (1 lap old) was being used to calculate gaps; ACC - fixed player car always being in a separate car class from opponents (should fix at least some of the inaccurate position calls)
