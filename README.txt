...
Changelog
---------
Version 4.14.0.4: Fixed 'force single class' option (was being ignored by the app); Fix timing issue in multiclass races for some games; Some rally mode improvements; R3E - added "What's the strength of field?" and "What are my incident points?" voice commands; iRacing - fixed missing meatball flag message; AMS2 - updated car mappings for new classes;
